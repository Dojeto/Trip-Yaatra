        ...
        <div>
            ...
            <div className="flex flex-col justify-center items-center mt-[35px]">
                <div className=" max-w-3xl">
                    <h1 className="text-2xl text-center font-semibold">What do we stand for and how did we reach to it?</h1>
                    <div className="mt-[50px] text-[17px]">
                        <p>Remember the days when we used to fill our slam-books with career aspirations like scientist, teacher and doctor? Nobody at that time thought there could’ve been a career in Travelling, let alone being a travelpreneur! But as life happens, you understand that a career could be anything where you can be a problem-solver for the society.
                        </p>
                        <p className="mt-[10px]">
                ...
                <div className=" mt-[30px]">
                    <details className={`w-[800px] ${isOpen1 ? 'open' : ''}`}>
                        ...
                        >
                            ...
                            <span className={`text-[25px] transform ${isOpen1 ? 'rotate-90' : 'rotate-0'}`}>
                                <FaAngleRight />
                            </span>
                        </summary>
                    ...
                    <details className={`w-[800px] ${isOpen2 ? 'open' : ''}`}>
                        ...
                        >
                            ...
                            <span className={`text-[25px] transform ${isOpen2 ? 'rotate-90' : 'rotate-0'}`}>
                                <FaAngleRight />
                            </span>
                        </summary>
                        <div className='mt-[10px]'>
                    ...
                    <details className={`w-[800px] ${isOpen3 ? 'open' : ''}`}>
                        ...
                        >
                            ...
                            <span className={`text-[25px] transform ${isOpen3 ? 'rotate-90' : 'rotate-0'}`}>
                                <FaAngleRight />
                            </span>
                        </summary>
                        <div className='mt-[10px]'>
                        ...
                        >
                            <div className="flex items-center">
                                ...
                                <span className="font-bold">
                                    Creative Mindset</span>
                            </div>
                            <span className={`text-[25px] transform ${isOpen4 ? 'rotate-90' : 'rotate-0'}`}>
                                <FaAngleRight />
                            </span>
                        </summary>
                        <div className='mt-[10px]'>
                    ...
                    <details className={`w-[800px] ${isOpen5 ? 'open' : ''}`}>
                        ...
                        >
                            ...
                            <span className={`text-[25px] transform ${isOpen5 ? 'rotate-90' : 'rotate-0'}`}>
                                <FaAngleRight />
                            </span>
                        </summary>
                        <div className='mt-[10px]'>
                ...
                <h1 className="text-[30px] mt-[40px] text-center font-bold">Our WARRIORS who have helped us build this holistic community</h1>
                <div className='mt-[30px] flex flex-row ' >
                    <div className="max-w-sm rounded bg-white flex flex-col items-center justify-center h-[400px]">
                        <img src="/assets/usp0.png" alt="Card" className="w-[100px] h-[100px]" />
                    ...
                    <div className="max-w-sm rounded bg-white flex flex-col items-center justify-center h-[400px]">
                        <img src="/assets/usp1.png" alt="Card" className="w-[100px] h-[100px]" />
                        <div className="px-6 py-4 text-center">
                    ...
                    <div className="max-w-sm rounded bg-white flex flex-col items-center justify-center h-[400px]">
                        <img src="/assets/usp2.png" alt="Card" className="w-[100px] h-[100px]" />
                        <div className="px-6 py-4 text-center">
