  ...
  return (
    <div className="sm:w-full relative">
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center">
        {/* Content inside */}
        <div className="w-[1200px] h-[300px] sm:w-[400px] sm:h-[100px] md:w-[700px] md:h-[150px]  flex justify-center items-center relative" style={{ backgroundColor: "rgba(5, 103, 125, 0.9)" }}>
          <div className="text-center ">
            <h1 className="text-4xl text-white font-bold md:text-2xl sm:text-lg">
